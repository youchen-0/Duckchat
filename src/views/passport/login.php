                                    ...
                                    <div style="position: relative; height: 100%;">
                                        <div>
                                            ...
                                            <div class=" d-flex flex-row justify-content-left login_name_div" >
                                                ...
                                                <?php else:?>
                                                    <input type="text" class="input_login_site  login_input_loginName" datatype="s" autocapitalize="off"  data-local-placeholder="loginNamePlaceholder" placeholder="请输入用户名" >
                                                <?php endif;?>
                                            ...
                                            <div class="login_name_div margin-top2">
                                                ...
                                                <input type="password" class="input_login_site phone_num  login_input_pwd" autocapitalize="off"  data-local-placeholder="enterPasswordPlaceholder"  onkeydown="loginPassportByKeyPress(event)"  placeholder="请输入密码, 长度5到20个字符(无中文)" >
