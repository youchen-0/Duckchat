                ...
                <div  class="login_div">
                    <div class="zaly_register zaly_site_register zaly_site_register-name" >
                        <div class="login_input_div" >
                            ...
                            <div class="d-flex flex-row justify-content-left login_name_div margin-top2 login_name_div_mobile" >
                                ...
                                <?php else:?>
                                    <input type="text" id="register_input_loginName"  datatype="s"  class="input_login_site  register_input_loginName" data-local-placeholder="registerLoginNamePlaceholder"  autocapitalize="off"   placeholder="请输入用户名" >
                                <?php endif;?>
                            ...
                            <?php if($nicknameRequired) :?>
                                <div class="login_name_div" style="margin-top: 1rem;">
                                    ...
                                    <input type="text" class="input_login_site register_input_nickname" autocapitalize="off"   id="register_input_nickname" data-local-placeholder="nicknamePlaceholder"  placeholder="请输入昵称"  >
                            ...
                            <div class="login_name_div" style="margin-top: 1rem;">
                                ...
                                <input type="password" class="input_login_site register_input_pwd" autocapitalize="off"   id="register_input_pwd" data-local-placeholder="enterPasswordPlaceholder"  placeholder="请输入密码"  >
                            ...
                            <div class="login_name_div" style="margin-top: 1rem;">
                                <img src="./public/img/login/pwd.png" class="img"/>
                                <input type="password" class="input_login_site register_input_repwd" autocapitalize="off"   id="register_input_repwd" data-local-placeholder="enterRepasswordPlaceholder"  placeholder="请再次输入密码"  >
                    ...
                    <div class="zaly_login zaly_site_register zaly_site_register-invitecode" style="display: none;">
                        ...
                        <div class="login_input_div" >
                            <div class="d-flex flex-row justify-content-center login-header"style="text-align: center;margin-top: 8rem;margin-bottom: 1rem;">
                                <span class="login_phone_tip_font" data-local-value="registerInvitationCodeTip" >请输入邀请码</span>
                            </div>

                            <div class="code_div login_name_div_mobile" style="margin-top: 8rem;">
                                <input type="text" class="input_login_site register_input_code" style="margin-left: 0rem;" data-local-placeholder="enterCodePlaceholder" autocapitalize="off"   placeholder="请输入邀请码"  >
                                <div class="line" ></div>
                            </div>
                    ...
                    <div class="zaly_login zaly_site_register zaly_site_update-invitecode" style="display: none;">
                        ...
                        <div class="login_input_div" >
                            ...
                            <div class="code_div login_name_div_mobile" style="margin-top: 8rem;">
                                <input type="text" class="input_login_site update_input_code" autocapitalize="off" style="margin-left: 0rem;" data-local-placeholder="enterCodePlaceholder" onkeydown="registerAndLoginByKeyDown(event)" placeholder="请输入邀请码"  >
                                <div class="line" ></div>
                            </div>
